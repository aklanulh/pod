        ...
        <form action="{{ route('kso-roi.store-kso-item') }}" method="POST" id="ksoItemForm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div>
                    ...
                    <input type="text" name="model" id="model" value="{{ old('model') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Model atau tipe">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    ...
                    <input type="number" name="nilai_alat_utama" id="nilai_alat_utama" value="{{ old('nilai_alat_utama') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" min="0" step="0.01">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div>
                    ...
                    <input type="number" name="durasi_kso_bulan" id="durasi_kso_bulan" value="{{ old('durasi_kso_bulan') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" min="1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    ...
                    <input type="text" name="lokasi_penempatan" id="lokasi_penempatan" value="{{ old('lokasi_penempatan') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Contoh: Lab Hematologi Lantai 2, Ruangan ICU">
            ...
            <div class="grid grid-cols-1 gap-6 mb-8">
                <div>
                    ...
                    <textarea name="keterangan" id="keterangan" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Contoh: Alat digunakan untuk pemeriksaan rutin pasien rawat jalan">{{ old('keterangan') }}</textarea>
