                        ...
                        <div class="support-item border border-gray-200 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="support_items[{{ $loop->index }}][kategori]" value="{{ old('support_items.' . $loop->index . '.kategori', $supportItem->kategori) }}" list="support-kategori-list" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Pilih atau ketik kategori">
